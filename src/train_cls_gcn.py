...
if __name__ == "__main__":
    """
    Train a GCN classifier based on the activations of the base model (victim model)
    """
    ...
    parser.add_argument("--datasets", nargs='+', default=['truthfulqa'], choices=["truthfulqa", "toxigen", "stereoset","pku-rlhf-10k","confaide"])
    parser.add_argument("--output_dir", default="activations", help="Directory to save activations to")
    parser.add_argument("--device", default="cuda:0")

    parser.add_argument("--detector_type", default="GCN")
